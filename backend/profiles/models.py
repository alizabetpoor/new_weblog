...
def validate_phonenumber(phonenumber):
    ...
    if not re.fullmatch(pattern,phonenumber):
        raise ValidationError(('شماره موبایل درست نمی باشد'),params={'phonenumber':phonenumber})


class User(AbstractUser):
    email=models.EmailField(unique=True,null=False,verbose_name="ایمیل",error_messages ={
...
class Profile(models.Model):
    ...
    phonenumber=models.CharField(max_length=13,unique=True,null=True,blank=True,validators=[validate_phonenumber],error_messages ={
